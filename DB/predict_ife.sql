...
--
-- Host: localhost:8889
-- Generation Time: Sep 17, 2017 at 05:51 PM
...
CREATE TABLE `make_free_predict` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `make_prediction_category` (
  `id` int(11) NOT NULL,
...
INSERT INTO `subscriptions` (`id`, `user_id`, `subscriber_id`, `amount`, `status`, `transaction_reference`, `card`, `created_at`, `updated_at`) VALUES
(1, 2, 2, '100', 1, 'T809688722297372', 'visa DEBIT', '2017-09-17 13:06:54', '2017-09-17 13:06:54'),
(2, 1, 2, '100', 1, 'T321588508170237', 'visa DEBIT', '2017-09-17 14:29:57', '2017-09-17 14:29:57');
...
(2, 'admin adminXYZ', 0, 'admin4@gmail.com', 0, 0, '$2y$10$ow78g0sZZSy4fGUw3WcEo.5LQ.AUZEsDqRSi.EUsqXfMFdHLOUJQO', NULL, '2017-09-01 21:17:59', '2017-09-01 21:17:59'),
...
CREATE TABLE `view_free_predict` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `count` int(11) NOT NULL,
  `updated_at` datetime NOT NULL,
...
--
-- Indexes for table `graded_games`
--
ALTER TABLE `graded_games`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `make_free_predict`
--
ALTER TABLE `make_free_predict`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `make_prediction_category`
--
ALTER TABLE `make_prediction_category`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `prediction_codes`
--
ALTER TABLE `prediction_codes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `sys_grades`
--
ALTER TABLE `sys_grades`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sys_ratings`
--
ALTER TABLE `sys_ratings`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `view_free_predict`
--
ALTER TABLE `view_free_predict`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `graded_games`
--
ALTER TABLE `graded_games`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
-- AUTO_INCREMENT for table `make_free_predict`
--
ALTER TABLE `make_free_predict`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `make_prediction_category`
--
ALTER TABLE `make_prediction_category`
...
--
-- AUTO_INCREMENT for table `prediction_codes`
--
ALTER TABLE `prediction_codes`
...
ALTER TABLE `subscriptions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `sys_grades`
--
ALTER TABLE `sys_grades`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `sys_ratings`
--
ALTER TABLE `sys_ratings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `user_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `view_free_predict`
--
ALTER TABLE `view_free_predict`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;